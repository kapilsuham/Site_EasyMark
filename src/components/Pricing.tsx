        ...
        <div id='pricing' className='pt-20 bg-secondary-content'>
            <div>
                ...
                <div className="mx-auto mb-12 max-w-2xl text-center lg:max-w-5xl">
                    <h1 className="text-3xl font-bold tracking-tight text-gray-200 sm:text-6xl lg:text-7xl">
                               ...
                               {i?.access?.map(i=>(
                                <ul key={i.id}>
                                    <li className="mb-2 flex items-center">
                                        <span><Image width={28} height={28} src="/tick.svg" alt="image" /></span>
                                ...
                                <ul key={i.id}>
                                    <li className="mb-2 flex items-center">
                                        <span><Image width={28} height={28} src="/cancel.svg" alt="image" /></span>
                                        <span className="ml-2 text-base">{i.tag}</span>
                                    </li>
                                </ul>))}

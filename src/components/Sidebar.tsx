    ...
    return (
        <div >
            ...
            <div className={ham ? ("-ml-[1000px] lg:ml-0") : ("")}>
                <aside className="flex fixed lg:absolute z-40 h-screen w-full lg:w-1/6 flex-col main overflow-y-auto bg-base-200 border-neutral text-base-content px-2 py-5">

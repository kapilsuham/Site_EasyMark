const WithAndWithout = () => {
    return (
        <div>
            <div className='text-base-content text-5xl mt-10 font-extrabold text-center'><span className='text-yellow-400'>What</span> makes <span className='text-yellow-400'>ShipForever</span> important</div>
                ...
                <div className="flex flex-col lg:flex-row gap-5">
                    <div className='lg:w-1/2'><div className="bg-error-content card text-error shadow-xl">
                        <div className="card-body text-center text-xl">
                            ...
                            <div><span>+6 hrs</span>  designing a landing page</div>
                            <div><span>+7 hrs</span> to handle Payment webhooks</div>
                            <div><span>+3 hrs</span> for Database setup with Schema</div>
                            <div><span>+6 hrs</span> applying Google Oauth</div>
                            <div><span>+3 hrs</span> for SEO tags</div>
                            <div><span>+6 hrs</span> applying for Google Oauth</div>
                            <div><span>+4 hrs</span> setup of DNS records</div>
                            <div><span>+6 hrs</span> for protected API routes</div>
                            <div><span>+ ∞ hrs</span> in error & overthinking...</div>
                            <div className="mt-4 text-2xl"><span className="text-red-500 font-semibold">=56 + ∞ hrs</span> in error & overthinking...</div>

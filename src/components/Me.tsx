    ...
    return (
        <div className='container m-auto mt-32 w-4/5 lg:w-1/2 text-secondary'>
            <div className='container justify-center lg:flex lg:gap-5'>
                <div className='lg:w-4/5 m-auto justify-center'><Image width={182} height={182} src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" alt="img" /></div>

    ...
    return (
        <div className='flex-wrap mt-10'>
            ...
            <div role="tablist_2" className="lg:tabs mt-10 lg:p-10 tabs-boxed lg:tabs-lg justify-center tabs-lifted">
                <input type="radio" name="my_tabs_2" role="tab" className="tab " aria-label="Why" defaultChecked />
                <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box p-6">
                    <div className='text-lg'>
                        <div className='flex lg:text-xl text-xs gap-2'>
                            <div><Image src="tick.svg" alt="image" /></div>
                ...
                <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box p-6">
                    <div className='text-lg'>
                        ...
                        <div className='flex lg:text-xl text-xs gap-2'>
                            <div><Image src="tick.svg" alt="image</div>" /></div>

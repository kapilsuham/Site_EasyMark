...
const TestimonialOne = () => {
    return (
        <div>
            <div className="text-base-content justify-center py-10 text-center min-h-screen bg-base-200">
                ...
                <div className="flex-col p-4 lg:w-1/2 text-center  justify-center m-auto lg:flex-row-reverse">
                    ...
                    <div>
                        <div className="avatar mt-5 gap-3">
                            ...
                            <div><div className='text-base-content font-extrabold'>ShipForever Customer</div>

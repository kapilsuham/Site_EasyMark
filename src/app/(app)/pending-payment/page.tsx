  ...
  return (
    <div className='pt-2 bg-secondary-content text-base-content'>
      ...
      <div className='flex justify-center mx-3 flex-wrap gap-2'>
        {plan?.map(i =>
          <div key={i?.id} className="card bg-base-100 mb-5 shadow-xl">
            ...
            <div className="card-body">
              <span className="mb-2 block pt-2 text-3xl font-extrabold text-yellow-400">{i?.name}</span>
              ...
              <div className="collapse bg-base-200 hover:bg-base-300">
                <input type="checkbox" />
                <div className="collapse-title text-xl text-center font-medium ">Plan Info</div>
